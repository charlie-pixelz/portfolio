...
const CONTENT = {
  es: { title: 'Contacto', tagline: '¿Trabajamos juntos?', inicio: 'Inicio' },
  en: { title: 'Contact', tagline: "Let's work together?", inicio: 'Home' },
}
...
export function initContacto({ lang }) {
  ...
  const revealTargets = [panel, inicioEl]
  ...
  const reveal = () => {
    ...
    gsap
      ...
      .fromTo(inicioEl, { opacity: 0, y: 14 }, { opacity: 1, y: 0, duration: 0.4, ease: 'power2.out' }, '-=0.3')
  }
